...
describe('Favorites module', () => {
  beforeEach(() => {
    jest.resetModules();
    document.body.innerHTML = '<div id="navbarCollapse"></div> <p></p> <div class="container-xxl"></div> <div class="navbar"></div> <h3></h3> <p></p> <div class="nav-item"></div> <h1></h1> <h4></h4>  <div class="row"></div> <div class="bgf"></div> <div class="bgdark"></div> <div id="divDark"></div>  <body></body> <button id="darkBtn"></button> <button id="largeFont"></button>';
    require('./createad.js')
  });
